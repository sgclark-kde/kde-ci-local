...
if sys.platform == "win32":
	scriptsLocation="D:/kderoot-live-test/scripts/"
	EMERGE_ETC="D:/kderoot-live-test/etc/"
	EMERGE_BASE="D:/kderoot-live-test"
else:
	scriptsLocation=home + "/scripts-live-test/"
...
def getRepository(repo_name, repoUrl, repoBranch="master"):		
		if repo_name == "scripts-live-test":
...
getRepository("scripts-live-test", "git://anongit.kde.org/sysadmin/ci-tools-experimental", JENKINS_BRANCH)
